...
{#if $page.url.pathname.startsWith("/app/blueprints/") && !$page.url.pathname.startsWith("/app/blueprints/shared/")}
  ...
  >
    <div class="absolute top-5 left-0 bottom-10 overflow-y-hidden">
      <BlueprintSideNav />
    </div>
    {#key data.url}
      <div
        class="absolute top-0 pt-4 left-64 right-0 bottom-0 overflow-y-auto scrollbar-none pb-8 px-2 overflow-x-hidden"

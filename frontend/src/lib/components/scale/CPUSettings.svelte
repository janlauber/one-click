...
<form>
  ...
  />
  <p class="text-xs text-gray-500 dark:text-gray-400">CPU requests are the guaranteed amount of CPU resources that a container will get.</p>
  <br />
  ...
  <Range
    ...
    max="4"
    step="0.1"
    bind:value={cpuLimitFloat}
  />
  <p class="text-xs text-gray-500 dark:text-gray-400">CPU limit is the maximum amount of CPU resources that a container can use.</p>
</form>

        ...
        >
          ...
          <span class="flex items-center">
            <span class="flex flex-col text-sm">
              <span id="server-size-1-label" class="font-medium">{technology?.name}</span>
              <span id="server-size-1-description-0" class=" hover:text-gray-600">
                <ExternalLink class="w-4 h-4 mr-1 inline-block" />
                <a href={technology.url} target="_blank" class="block sm:inline underline">
                  {technology.url}</a
                >
              </span>
            </span>
          ...
          >
            <img
              src={technologyLogoUrl(technology)}
              alt={technology?.name}
